...
public class ApplicationService {
	...
	public ApplicationService(ApplicationRepository applications, JobOfferRepository offers,
			UserRepository users, MatchingService matching, StorageService storage) {
	...
	public List<HrApplicationDto> forOffer(Integer offerId) {
		return applications.findByOffer(offerId).stream()
				.map(ApplicationMapper::toHrView)
				.toList();
	}
